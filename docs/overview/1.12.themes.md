...
This means a property will not use the value defined in a theme when that property was explicitly set.
...
This theme, by default, detects if the system or the app uses dark mode. If so, charts will adapt to the user or app preferences:

![image](https://raw.githubusercontent.com/beto-rodriguez/LiveCharts2/master/docs/_assets/light-and-dark-charts.gif)

...
[TestClass]
public sealed class OhlcSeriesTests
{
    [TestMethod]
    public void Basic()
    {
        ...
        {
            Series = [
                new OhlcSeries<FinancialPointI> { Values = values }
            ],
            Width = 600,
            Height = 600
        };

        chart.AssertSnapshotMatches($"{nameof(OhlcSeriesTests)}_{nameof(Basic)}");
    }
    ...
    public void DateTime()
    {
        ...
        {
            Series = [
                new OhlcSeries<FinancialPoint> { Values = values }
            ],
            XAxes = [
                new Axis
                {
        ...
        chart.AssertSnapshotMatches($"{nameof(OhlcSeriesTests)}_{nameof(DateTime)}");
    }
}
